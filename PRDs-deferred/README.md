...
PRDs parked OUT of the top-level `/build` scan (scan-prds.sh uses `find -maxdepth 1`).
They remain drafted but are NOT auto-built until moved back to the top level.
